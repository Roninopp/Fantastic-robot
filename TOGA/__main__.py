...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(toga_callback_data, pattern=r"toga_")
    toga_callback_handler = CallbackQueryHandler(about_callback_data, pattern=r"about_")
